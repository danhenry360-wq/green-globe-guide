...
/* ----------------------------------------------------
   FULL WORLD DATA (Rigorous Audit 2025)
----------------------------------------------------- */
    ...
    countries: [
      {
        ...
        description: "Personal consumption in private is decriminalized, but selling is illegal.",
        image: "/dest-5.jpg",
        regions: [
          {
  ...
  },
  {
    ...
    countries: [
      ...
      },
      {
        ...
        description: "Medical cannabis trials; recreational use illegal.",
        image: "/dest-5.jpg",
        regions: [
          {
            slug: "ile-de-france",
            name: "Île-de-France",
            cities: [{ slug: "paris", name: "Paris", atGlance: ["Romantic capital", "Medical only", "No public use"] }],
          },
          {
            slug: "provence",
            name: "Provence",
      ...
      },
      {
        ...
        description: "Medical cannabis legal; recreational use prohibited.",
        image: "/dest-5.jpg",
        regions: [{ slug: "istanbul-region", name: "Istanbul Region", cities: [{ slug: "istanbul", name: "Istanbul", atGlance: ["East-meets-west", "Medical only", "Bosphorus views"] }] }, { slug: "ankara-region", name: "Ankara Region", cities: [{ slug: "ankara", name: "Ankara", atGlance: ["Capital city", "Medical only", "Anıtkabir"] }] }],
      },
      {
        slug: "cyprus",
        name: "Cyprus",
    ...
    countries: [
      {
        ...
        tourist: "Shops currently open, but laws are tightening fast",
        description: "Cannabis was delisted as a narcotic in 2022. Shops exist, but the gov is moving to restrict recreational use.",
        image: "/dest-6.jpg",
        regions: [
          {
            slug: "bangkok-region",
  ...
  },
  {
    ...
    countries: [
      ...
      },
      {
        ...
        legalStatus: "Recreational", // CORRECTED: Legalized Jan 2023
        possession: "Recreational legal (21+)",
        airport: "Zero tolerance (Federal law)",
        tourist: "Dispensaries opening; consumption legal",
        description: "Recreational cannabis legalized in 2023. Public consumption restrictions apply.",
        image: "/dest-4.jpg",
        regions: [{ slug: "charlotte-amalie-region", name: "Charlotte Amalie Region", cities: [{ slug: "charlotte-amalie", name: "Charlotte Amalie", atGlance: ["Tax-free port", "Legal", "Caribbean US"] }] }],
      },
      {
        slug: "antigua-barbuda",
        name: "Antigua & Barbuda",
        legalStatus: "Decriminalized", // CORRECTED
        possession: "15g possession decriminalized",
        airport: "Zero tolerance",
        tourist: "Decriminalized small amounts; 365 beaches",
        description: "Possession of up to 15g is decriminalized. Rastafarian sacraments legal.",
        image: "/dest-5.jpg",
      ...
      },
      {
        ...
        name: "Dominica",
        legalStatus: "Decriminalized", // CORRECTED
        possession: "28g possession decriminalized",
        airport: "Zero tolerance",
        tourist: "Nature island; small amounts OK",
        description: "Possession of up to 28g decriminalized for personal use.",
        image: "/dest-4.jpg",
        regions: [{ slug: "roseau-region", name: "Roseau Region", cities: [{ slug: "roseau", name: "Roseau", atGlance: ["Nature capital", "Decriminalized", "Whale watching"] }] }],
      },
      {
        slug: "st-lucia",
        name: "St Lucia",
        legalStatus: "Decriminalized", // CORRECTED
        possession: "30g possession decriminalized",
        airport: "Zero tolerance",
        tourist: "Piton peaks; small amounts OK",
        description: "Possession of up to 30g decriminalized.",
        image: "/dest-5.jpg",
        regions: [{ slug: "castries-region", name: "Castries Region", cities: [{ slug: "castries", name: "Castries", atGlance: ["Piton backdrop", "Decriminalized", "Cruise port"] }] }],
      },
      {
        slug: "st-vincent-grenadines",
        name: "St Vincent & the Grenadines",
        legalStatus: "Decriminalized", // CORRECTED
        possession: "56g possession decriminalized",
        airport: "Zero tolerance",
        tourist: "Medical legal; small amounts decrim",
        description: "Medical cannabis industry active; possession of up to 2oz (56g) decriminalized.",
        image: "/dest-4.jpg",
        regions: [{ slug: "kingstown-region", name: "Kingstown Region", cities: [{ slug: "kingstown", name: "Kingstown", atGlance: ["Yacht hub", "Decriminalized", "Volcano views"] }] }],
      },
      {
        slug: "trinidad-tobago",
        name: "Trinidad & Tobago",
        legalStatus: "Decriminalized", // CONFIRMED
        possession: "30 g allowed",
        airport: "Zero tolerance",
        tourist: "Enjoy carnival; small amounts legal",
        description: "Decriminalised 2019; adults can possess up to 30g.",
        image: "/dest-4.jpg",
        regions: [{ slug: "port-of-spain-region", name: "Port of Spain Region", cities: [{ slug: "port-of-spain", name: "Port of Spain", atGlance: ["Carnival capital", "30g allowed", "Medical clinics"] }] }],
      },
      {
        slug: "barbados",
        name: "Barbados",
