  ...
  },
  {
    ...
    countries: [
        ...
        regions: [
          {
            ...
            cities: [
              ...
              },
              {
                slug: "haarlem",
                name: "Haarlem",
                atGlance: ["Quieter than AMS", "Good quality", "Easy day-trip"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                ...
                atGlance: [
                  "St. Pauli most open",
                  "Harbour lounges discreet",
                  "Use trams, don’t drive",
                ],
              },
            ],
          },
            ...
            cities: [
              {
                slug: "geneva",
                name: "Geneva",
                atGlance: ["Diplomatic city", "Discreet only", "Lake views"],
              },
            ],
          },
        ],
      },
      {
        ...
        description:
          "Possession of small amounts decriminalised; hemp shops legal.",
        image: "/dest-6.jpg",
        regions: [
          {
            slug: "vienna-region",
            ...
            cities: [
              {
                slug: "vienna",
                name: "Vienna",
                atGlance: ["Coffee-house culture", "Hemp stores", "No public use"],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        description:
          "Personal use decriminalised; public use fined.",
        image: "/dest-6.jpg",
        regions: [
          {
            slug: "brussels-region",
            name: "Brussels Region",
            cities: [
              {
                slug: "brussels",
                name: "Brussels",
                atGlance: ["EU capital", "Discreet only", "Chocolate & beer"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "marseille",
                name: "Marseille",
                atGlance: ["Port city", "Sun & sea", "Discreet only"],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        description:
          "Medical cannabis pilot; recreational use illegal.",
        image: "/dest-6.jpg",
        regions: [
          {
            slug: "dublin-region",
            ...
            cities: [
              {
                slug: "dublin",
                name: "Dublin",
                atGlance: ["Pub culture", "Medical only", "Discreet only"],
              },
            ],
          },
        ],
      },
      {
        ...
        description:
          "Medical cannabis legal; Christiania enclave tolerated.",
        image: "/dest-3.jpg",
        regions: [
          {
            ...
            cities: [
              {
                slug: "oslo",
                name: "Oslo",
                atGlance: ["Fjord capital", "Medical only", "Outdoor life"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "stockholm-region",
            name: "Stockholm Region",
            cities: [
              {
                slug: "stockholm",
                name: "Stockholm",
                atGlance: ["Archipelago capital", "Medical only", "Design hub"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "reykjavik-region",
            name: "Reykjavik Region",
            cities: [
              {
                slug: "reykjavik",
                name: "Reykjavik",
                atGlance: ["Northern lights", "Medical only", "Small-town vibe"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "tallinn",
                name: "Tallinn",
                atGlance: ["Medieval old town", "Medical only", "Tech hub"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "riga",
                name: "Riga",
                atGlance: ["Art-Nouveau capital", "Medical only", " Baltic beaches"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "vilnius",
                name: "Vilnius",
                atGlance: ["Baroque old town", "Medical only", "Cheap beer"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "warsaw",
                name: "Warsaw",
                atGlance: ["Rebuilt capital", "Medical only", "Vodka culture"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "krakow",
                name: "Kraków",
                atGlance: ["Medieval core", "Medical only", "Student vibe"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "ljubljana-region",
            name: "Ljubljana Region",
            cities: [
              {
                slug: "ljubljana",
                name: "Ljubljana",
                atGlance: ["Dragon bridge", "Medical only", "Green capital"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "bratislava-region",
            name: "Bratislava Region",
            cities: [
              {
                slug: "bratislava",
                name: "Bratislava",
                atGlance: ["Danube capital", "Medical only", "Cheap beer"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "budapest-region",
            name: "Budapest Region",
            cities: [
              {
                slug: "budapest",
                name: "Budapest",
                atGlance: ["Thermal baths", "Medical only", "Nightlife"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "zagreb",
                name: "Zagreb",
                atGlance: ["Capital cafes", "Medical only", "Cheap coffee"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "split",
                name: "Split",
                atGlance: ["Diocletian palace", "Medical only", "Coast relax"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "belgrade-region",
            name: "Belgrade Region",
            cities: [
              {
                slug: "belgrade",
                name: "Belgrade",
                atGlance: ["Danube nightlife", "Medical only", "Cheap rakija"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "sarajevo-region",
            name: "Sarajevo Region",
            cities: [
              {
                slug: "sarajevo",
                name: "Sarajevo",
                atGlance: [" Ottoman old town", "Medical only", "Coffee culture"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "podgorica",
                name: "Podgorica",
                atGlance: ["Small capital", "Medical only", "Mountain lakes"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "skopje",
                name: "Skopje",
                atGlance: ["Balkan capital", "Medical only", "Cheap wine"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "tirana",
                name: "Tirana",
                atGlance: ["Colourful capital", "Medical only", "Cheap coffee"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "athens",
                name: "Athens",
                atGlance: ["Acropolis views", "Medical only", "Ancient history"],
              },
            ],
          },
          {
            slug: "thessaloniki-region",
            name: "Thessaloniki Region",
            cities: [
              {
                slug: "thessaloniki",
                name: "Thessaloniki",
                atGlance: ["Northern port", "Medical only", "Student vibe"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "sofia",
                name: "Sofia",
                atGlance: ["Mountain capital", "Medical only", "Cheap eats"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "bucharest-region",
            name: "Bucharest Region",
            cities: [
              {
                slug: "bucharest",
                name: "Bucharest",
                atGlance: ["Party capital", "Medical only", "Cheap beer"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "chisinau-region",
            name: "Chișinău Region",
            cities: [
              {
                slug: "chisinau",
                name: "Chișinău",
                atGlance: ["Wine capital", "Medical only", "Cheap wine"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "kyiv",
                name: "Kyiv",
                atGlance: ["Wartime capital", "Medical only", "Check travel advisories"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          ...
          {
            slug: "stpetersburg-region",
            name: "St Petersburg Region",
            cities: [
              {
                slug: "saint-petersburg",
                name: "Saint Petersburg",
                atGlance: ["Hermitage", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "minsk",
                name: "Minsk",
                atGlance: ["Soviet capital", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
      },
      {
        ...
        possession: "Medical prescription only",
        airport: "Zero tolerance",
        tourist: "Medical only; enjoy kebabs",
        description:
          "Medical cannabis legal; recreational use prohibited.",
        image: "/dest-5.jpg",
        regions: [
            ...
            cities: [
              {
                slug: "istanbul",
                name: "Istanbul",
                atGlance: ["East-meets-west", "Medical only", "Bosphorus views"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "ankara",
                name: "Ankara",
                atGlance: ["Capital city", "Medical only", "Anıtkabir"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "nicosia",
                name: "Nicosia",
                atGlance: ["Divided capital", "Medical only", "Beach close"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "tbilisi",
                name: "Tbilisi",
                atGlance: ["Caucasus capital", "Medical only", "Wine culture"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "yerevan",
                name: "Yerevan",
                atGlance: ["Pink capital", "Medical only", "Caucasus views"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "baku",
                name: "Baku",
                atGlance: ["Caspian capital", "Medical only", "Flame towers"],
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    countries: [
            ...
            cities: [
              {
                slug: "mendoza",
                name: "Mendoza",
                atGlance: ["Wine region", "Medical only", "Andes views"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "caracas",
                name: "Caracas",
                atGlance: ["Crime capital", "Illegal", "Avoid travel"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "quito",
                name: "Quito",
                atGlance: ["High-altitude capital", "Medical only", "Colonial centre"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "la-paz",
                name: "La Paz",
                atGlance: ["High-altitude seat", "Medical only", "Witches’ market"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "asuncion-region",
            name: "Asunción Region",
            cities: [
              {
                slug: "asuncion",
                name: "Asunción",
                atGlance: ["River capital", "Medical only", "Cheap beer"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "georgetown-region",
            name: "Georgetown Region",
            cities: [
              {
                slug: "georgetown",
                name: "Georgetown",
                atGlance: ["Caribbean-flavoured", "Illegal", "Jungle gateway"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "paramaribo-region",
            name: "Paramaribo Region",
            cities: [
              {
                slug: "paramaribo",
                name: "Paramaribo",
                atGlance: ["Wooden capital", "Illegal", "Rainforest"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "cayenne",
                name: "Cayenne",
                atGlance: ["EU Amazon outpost", "Medical only", "Space centre"],
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    countries: [
      ...
      },
      {
        ...
        regions: [
          {
            slug: "port-au-prince-region",
            name: "Port-au-Prince Region",
            cities: [
              {
                slug: "port-au-prince",
                name: "Port-au-Prince",
      ...
      },
      {
        ...
        regions: [
          {
            slug: "san-juan-region",
            name: "San Juan Region",
            cities: [
              {
                slug: "san-juan",
                name: "San Juan",
                atGlance: ["US island", "Medical only", "Beach vibes"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "charlotte-amalie-region",
            name: "Charlotte Amalie Region",
            cities: [
              {
                slug: "charlotte-amalie",
                name: "Charlotte Amalie",
                atGlance: ["Tax-free port", "Medical only", "Caribbean US"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "road-town-region",
            name: "Road Town Region",
            cities: [
              {
                slug: "road-town",
                name: "Road Town",
                atGlance: ["Yacht hub", "Medical only", "UK Caribbean"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "the-valley-region",
            name: "The Valley Region",
            cities: [
              {
                slug: "the-valley",
                name: "The Valley",
                atGlance: ["Tiny capital", "Medical only", "Peaceful beaches"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "philipsburg-region",
            name: "Philipsburg Region",
            cities: [
              {
                slug: "philipsburg",
                name: "Philipsburg",
                atGlance: ["Dual-nation capital", "Medical only", "Duty-free"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "basseterre-region",
            name: "Basseterre Region",
            cities: [
              {
                slug: "basseterre",
                name: "Basseterre",
                atGlance: ["Twin capital", "Medical only", "Beach cricket"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "st-johns-region",
            name: "St John’s Region",
            cities: [
              {
                slug: "st-johns",
                name: "St John’s",
                atGlance: ["365 beaches", "Medical only", "Sailing hub"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "roseau",
                name: "Roseau",
                atGlance: ["Nature capital", "Medical only", "Whale watching"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "st-georges-region",
            name: "St George’s Region",
            cities: [
              {
                slug: "st-georges",
                name: "St George’s",
                atGlance: ["Spice capital", "Medical only", "Port lagoon"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "castries-region",
            name: "Castries Region",
            cities: [
              {
                slug: "castries",
                name: "Castries",
                atGlance: ["Piton backdrop", "Medical only", "Cruise port"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "kingstown-region",
            name: "Kingstown Region",
            cities: [
              {
                slug: "kingstown",
                name: "Kingstown",
                atGlance: ["Yacht hub", "Medical only", "Volcano views"],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        tourist: "Residents only; tourists cannot buy",
        description:
          "Legalised 2022; no commercial sales yet.",
        image: "/dest-5.jpg",
        regions: [
          {
            slug: "hamilton-region",
            name: "Hamilton Region",
            cities: [
              {
                slug: "hamilton",
                name: "Hamilton",
                atGlance: ["Atlantic isle", "Home grow only", "Pastel houses"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "george-town-region",
            name: "George Town Region",
            cities: [
              {
                slug: "george-town",
                name: "George Town",
                atGlance: ["Offshore hub", "Medical only", "Seven-mile beach"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "cockburn-town-region",
            name: "Cockburn Town Region",
            cities: [
              {
                slug: "cockburn-town",
                name: "Cockburn Town",
                atGlance: ["Luxury capital", "Medical only", "Grace Bay"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "oranjestad-region",
            name: "Oranjestad Region",
            cities: [
              {
                slug: "oranjestad",
                name: "Oranjestad",
                atGlance: ["Dutch-Caribbean", "Illegal", "Eagle beach"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "willemstad-region",
            name: "Willemstad Region",
            cities: [
              {
                slug: "willemstad",
                name: "Willemstad",
                atGlance: ["Coloured capital", "Medical only", "Dutch-Caribbean"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "kralendijk-region",
            name: "Kralendijk Region",
            cities: [
              {
                slug: "kralendijk",
                name: "Kralendijk",
                atGlance: ["Dive capital", "Medical only", "Salt pans"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "oranjestad-eustatius-region",
            name: "Oranjestad Region",
            cities: [
              {
                slug: "oranjestad-eustatius",
                name: "Oranjestad",
                atGlance: ["Volcano views", "Medical only", "Quiet island"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "the-bottom-region",
            name: "The Bottom Region",
            cities: [
              {
                slug: "the-bottom",
                name: "The Bottom",
                atGlance: ["Shortest runway", "Medical only", "Mountain village"],
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    countries: [
            ...
            cities: [
              {
                slug: "taipei",
                name: "Taipei",
                atGlance: ["Night-market capital", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "hong-kong",
                name: "Hong Kong",
                atGlance: ["Skyline harbour", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "macau",
                name: "Macau",
                atGlance: ["Casino capital", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
      },
      {
        ...
        possession: "Medical prescription only",
        airport: "Zero tolerance",
        tourist: "Medical only; bhang lassi tolerated",
        description:
            ...
            cities: [
              {
                slug: "mumbai",
                name: "Mumbai",
                atGlance: ["Bollywood hub", "Medical only", "Street food"],
              },
            ],
          },
          {
      ...
      },
      {
        ...
        regions: [
          {
            slug: "islamabad-region",
            name: "Islamabad Region",
            cities: [
              {
                slug: "islamabad",
                name: "Islamabad",
                atGlance: ["Planned capital", "Illegal", "Severe penalties"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "karachi",
                name: "Karachi",
                atGlance: ["Coastal mega-city", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "dhaka",
                name: "Dhaka",
                atGlance: ["Mega-delta capital", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "colombo",
                name: "Colombo",
                atGlance: ["Port capital", "Medical only", "Ceylon tea"],
              },
            ],
          },
        ],
      },
      {
        ...
        description:
          "Cannabis illegal; historical hashish tolerated in pilgrim areas only.",
        image: "/dest-6.jpg",
        regions: [
          {
            slug: "kathmandu-region",
            name: "Kathmandu Region",
            cities: [
              {
                slug: "kathmandu",
                name: "Kathmandu",
                atGlance: ["Temple capital", "Illegal", "Hash history"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "thimphu",
                name: "Thimphu",
                atGlance: ["Mountain capital", "Illegal", "Gross-national happiness"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "male",
                name: "Malé",
                atGlance: ["Coral capital", "Illegal", "Resort islands"],
              },
            ],
          },
        ],
      },
      {
        ...
        description:
          "Cannabis illegal; production region but prohibited.",
        image: "/dest-6.jpg",
        regions: [
          {
            slug: "kabul-region",
            ...
            cities: [
              {
                slug: "tehran",
                name: "Tehran",
                atGlance: ["Mountain capital", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "baghdad",
                name: "Baghdad",
                atGlance: ["Tigris capital", "Illegal", "Avoid travel"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "damascus-region",
            name: "Damascus Region",
            cities: [
              {
                slug: "damascus",
                name: "Damascus",
                atGlance: ["Ancient capital", "Illegal", "Avoid travel"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "beirut",
                name: "Beirut",
                atGlance: ["Party capital", "Medical only", "Bekaa hash history"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "jerusalem",
                name: "Jerusalem",
                atGlance: ["Holy city", "Medical only", "Ancient walls"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "ramallah-region",
            name: "Ramallah Region",
            cities: [
              {
                slug: "ramallah",
                name: "Ramallah",
                atGlance: ["De-facto capital", "Illegal", "Conflict zone"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "amman",
                name: "Amman",
                atGlance: ["Hilly capital", "Medical only", "Petra gateway"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "riyadh",
                name: "Riyadh",
                atGlance: ["Desert capital", "Illegal", "Extreme penalties"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "jeddah",
                name: "Jeddah",
                atGlance: ["Red-Sea port", "Illegal", "Extreme penalties"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "dubai",
                name: "Dubai",
                atGlance: ["Futuristic city", "Medical only", "Zero-tolerance airport"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "abu-dhabi",
                name: "Abu Dhabi",
                atGlance: ["Oil capital", "Medical only", "Grand mosque"],
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    countries: [
        ...
        regions: [
          {
            ...
            cities: [
              ...
              },
              {
                slug: "stellenbosch",
                name: "Stellenbosch",
                atGlance: ["Wine capital", "Private use", "University town"],
              },
            ],
          },
          {
            ...
            cities: [
              ...
              },
              {
                slug: "pretoria",
                name: "Pretoria",
                atGlance: ["Jacaranda city", "Private use", "Embassy hub"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "harare",
                name: "Harare",
                atGlance: ["Garden capital", "Medical only", "Victoria Falls gateway"],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        regions: [
          {
            slug: "casablanca-region",
            name: "Casablanca Region",
            cities: [
              {
                slug: "casablanca",
                name: "Casablanca",
                atGlance: ["Commercial capital", "Illegal", "Tolerated Rif only"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "accra",
                name: "Accra",
                atGlance: ["Coastal capital", "Medical only", "Gold-coast vibes"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "lagos",
                name: "Lagos",
                atGlance: ["Mega-city", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        regions: [
          {
            slug: "addis-ababa-region",
            name: "Addis Ababa Region",
            cities: [
              {
                slug: "addis-ababa",
                name: "Addis Ababa",
                atGlance: ["Coffee capital", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        regions: [
          {
            slug: "djibouti-city-region",
            name: "Djibouti City Region",
            cities: [
              {
                slug: "djibouti-city",
                name: "Djibouti City",
                atGlance: ["Military port", "Illegal", "Desert heat"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "asmara",
                name: "Asmara",
                atGlance: ["Art-deco capital", "Illegal", "Closed nation"],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        regions: [
          {
            slug: "khartoum-region",
            name: "Khartoum Region",
            cities: [
              {
                slug: "khartoum",
                name: "Khartoum",
                atGlance: ["Nile confluence", "Illegal", "Conflict zone"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "tunis",
                name: "Tunis",
                atGlance: ["Medina capital", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "algiers",
                name: "Algiers",
                atGlance: ["White capital", "Illegal", "Severe penalties"],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        regions: [
          {
            slug: "saint-denis-region",
            name: "Saint-Denis Region",
            cities: [
              {
                slug: "saint-denis-reunion",
                name: "Saint-Denis",
                atGlance: ["Volcano capital", "Medical only", "French island"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "mamoudzou-region",
            name: "Mamoudzou Region",
            cities: [
              {
                slug: "mamoudzou",
                name: "Mamoudzou",
                atGlance: ["Lagoon capital", "Medical only", "French island"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "strombine-region",
            name: "Strombine Region",
            cities: [
              {
                slug: "strombine",
                name: "Strombine",
  ...
  },
  {
    ...
    countries: [
            ...
            cities: [
              {
                slug: "noumea",
                name: "Nouméa",
                atGlance: ["French Pacific", "Medical only", "Coral lagoon"],
              },
            ],
          },
        ],
            ...
            cities: [
              {
                slug: "papeete",
                name: "Papeete",
                atGlance: ["Tahiti capital", "Medical only", "Pearl lagoon"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "mata-utu-region",
            name: "Mata-Utu Region",
            cities: [
              {
                slug: "mata-utu",
                name: "Mata-Utu",
                atGlance: ["French Pacific", "Medical only", "Remote"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "kingston-norfolk-region",
            name: "Kingston Norfolk Region",
            cities: [
              {
                slug: "kingston-norfolk",
                name: "Kingston",
                atGlance: ["Pine capital", "Medical only", "Australian"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "west-island-region",
            name: "West Island Region",
            cities: [
              {
                slug: "west-island",
                name: "West Island",
                atGlance: ["Coconut capital", "Medical only", "Australian"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "flying-fish-cove-region",
            name: "Flying Fish Cove Region",
            cities: [
              {
                slug: "flying-fish-cove",
                name: "Flying Fish Cove",
                atGlance: ["Crab capital", "Medical only", "Australian"],
              },
            ],
          },
        ],
      },
      {
        ...
        regions: [
          {
            slug: "adamstown-region",
            name: "Adamstown Region",
            cities: [
              {
                slug: "adamstown",
                name: "Adamstown",
                atGlance: ["Remote capital", "Medical only", "UK territory"],
              },
            ],
          },
        ],
        ...
        regions: [
          {
            ...
            cities: [
              ...
              },
              {
                slug: "north-shore",
                name: "North Shore",
                atGlance: ["Surf vibe", "Private use", "Scenic drives"],
              },
            ],
          },
          {
            ...
            cities: [
              {
                slug: "hilo",
                name: "Hilo",
                atGlance: ["Rainy side", "Home-grow culture", "Volcano views"],
              },
              {
                slug: "kona",
                name: "Kona",
                atGlance: ["Sunny side", "Dispensary available", "Coffee farms"],
              },
            ],
          },
        ],
...
const ContinentIndex = () => {
  ...
  // Define continent data with emojis for mobile view
  ...
  const selectedContinentData = selectedContinent 
    ? WORLD.find((c) => c.slug === selectedContinent) 
    : null;

  // Mobile continent selector view
  if (!selectedContinent) {
    return (
      <div className="container mx-auto max-w-7xl px-4 pt-24 pb-12">
        ...
        {/* Continent Grid Cards */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.2 }}
          className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl border border-accent/30 p-4 md:p-6 shadow-[0_0_60px_-20px_rgba(34,197,94,0.3)]"
        >
          <div className="grid grid-cols-2 gap-4">
            {WORLD.map((continent, index) => (
              <motion.button
                key={continent.slug}
                ...
                className="relative bg-card/60 hover:bg-card/80 rounded-2xl border border-border/50 hover:border-accent/50 p-4 md:p-6 text-center transition-all duration-300 group"
              >
                <span className="text-4xl md:text-5xl mb-3 block">
                  {continentEmojis[continent.slug] || "🌍"}
                </span>
                <h3 className="text-lg md:text-xl font-bold text-white mb-1 group-hover:text-accent transition-colors">
                  {continent.name === "North America" ? "Americas" : continent.name}
                </h3>
        ...
        >
          {[
            { status: 'Recreational', color: '#22c55e' },
            { status: 'Medical Only', color: '#3b82f6' },
            { status: 'Decriminalized', color: '#eab308' },
            { status: 'Illegal', color: '#ef4444' },
          ].map((item) => (
  ...
  // Selected continent - show countries list
  return (
    <div className="container mx-auto max-w-7xl px-4 pt-24 pb-12">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <span className="text-3xl">{continentEmojis[selectedContinent] || "🌍"}</span>
          <h1 className="text-2xl md:text-4xl font-bold">
            {selectedContinentData?.name === "North America" ? "Americas" : selectedContinentData?.name}
          </h1>
          <Button
            variant="outline"
            size="sm"
      ...
      <div className="space-y-3">
        {selectedContinentData?.countries.map((country, index) => {
          const statusColors: Record<string, string> = {
            "Recreational": "bg-green-500",
            "Medical": "bg-blue-500",
            "Decriminalized": "bg-yellow-500",
            "Illegal": "bg-red-500",
          };
          const dotColor = statusColors[country.legalStatus] || "bg-gray-500";
          ...
          return (
            ...
            >
              <Card
                className="p-4 bg-card/60 border-border/50 hover:border-accent/50 cursor-pointer transition-all"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge className={`${statusColor(country.legalStatus)} border-none text-xs`}>
                        {country.legalStatus}
                      </Badge>
                    </div>
      ...
      <motion.div
        ...
        className="flex flex-wrap justify-center gap-4 mt-8 pt-6 border-t border-border/30"
      >
        {[
          { status: 'Recreational', color: 'bg-green-500' },
          { status: 'Medical Only', color: 'bg-blue-500' },
          { status: 'Decriminalized', color: 'bg-yellow-500' },
          { status: 'Illegal', color: 'bg-red-500' },
        ].map((item) => (
          <div key={item.status} className="flex items-center gap-2">
