      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Green Globe is the world's first attorney-verified cannabis travel platform. We
            translate complex weed laws into clear itineraries so you can explore the planet's most
            420-friendly destinations—without the legal guesswork.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: 'A licensed attorney in the relevant jurisdiction reviews the raw text, cross-checks with local bar associations, and drafts the plain-language summary.',
              },
              {
                step: 3,
                title: 'Community Feedback',
                desc: 'Within 48 hours of publication, on-the-ground travelers validate airport experiences, dispensary menus, and hotel policies—ensuring real-world accuracy.',
              },
            ].map((s) => (
              <Card key={s.step} className="p-6 bg-gradient-card border-border/50">
