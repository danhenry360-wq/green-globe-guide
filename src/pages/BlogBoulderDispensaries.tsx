                ...
                <Card className="bg-gradient-to-r from-accent/10 to-gold/5 border-accent/30 p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Consume legally at private residences (with owner permission), verified 420-friendly rentals, or licensed consumption lounges. Boulder has a progressive cannabis culture with some dispensaries offering outdoor patios.</p>
                    </div>
                  </div>
                </Card>
              </div>
