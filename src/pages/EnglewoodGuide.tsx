...
const EnglewoodGuide = () => {
  ...
  const seasons = [
    ...
    },
    {
      ...
      tip: "The Gothic Theatre is a great winter venue—intimate and warm."
    }
  ];
          ...
          <div className="relative z-10 container mx-auto px-4 text-center max-w-4xl">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                A vibrant city bordering Denver, famous for "The Green Mile"—a stretch of South Broadway with one of the highest concentrations of dispensaries in the state.
              </p>
