...
// Import your existing MapLegend component
        ...
        <div className="hidden md:flex md:space-x-8">
          ...
          <div className="md:w-3/4">
            ...
            <h1 className="text-3xl font-bold mb-6 text-white">
              USA Cannabis Guide ({filteredStates.length} States)
            </h1>
              ...
              {filteredStates.map((state) => (
                ...
                >
                  <div className="p-4">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium mt-2 inline-block ${
                        state.legalStatus === "Recreational"
                          ? "bg-green-900 text-green-100"
                          : state.legalStatus === "Medical Only"
                    ...
                    <a href="#" className="text-green-400 text-sm mt-2 inline-block">
                      View full guide
                    </a>
                  </div>
                </div>
