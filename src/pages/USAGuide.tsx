...
// 2. State Mapping (All 50 States + DC)
      ...
      <div className="pt-24 pb-20 md:pt-32 md:pb-24">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <motion.div 
            ...
            animate={{ opacity: 1, y: 0 }}
          >
            {/* FIXED: Exact Gradient from About Page */}
            <h1 className="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-foreground via-accent to-gold bg-clip-text text-transparent pb-2">
              {pageTitle}
            </h1>
