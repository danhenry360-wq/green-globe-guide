...
const MOCK_TOUR_IMAGES: Record<string, string[]> = {
  'beyond-light-show-meditation': [
    '/tours/beyond-light-show-denver.jpg',
    '/tours/beyond-light-show-denver.jpg',
    '/tours/beyond-light-show-denver.jpg',
    '/tours/beyond-light-show-denver.jpg',
    '/tours/beyond-light-show-denver.jpg'
...
const TourDetail = () => {
  ...
  // Use mock images if available and tour doesn't have multiple images, otherwise use tour images
  const allImages = (mockImages && mockImages.length > 1) ? mockImages : (tour.images?.filter(img => img) || mockImages || ['/tours/beyond-light-show-denver.jpg']);
