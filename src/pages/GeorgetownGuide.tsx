...
const GeorgetownGuide = () => {
  ...
  return (
    <>
      <Helmet>
        <title>🌿 420 Georgetown Cannabis Guide 2025 | Historic Mountain Town | BudQuest</title>
        ...
        <meta property="og:title" content="🌿 420 Georgetown Cannabis Guide 2025 | BudQuest" />
